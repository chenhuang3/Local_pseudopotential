...
!
      subroutine psatom_chen(it,igr,iexc,z,nc,nv,
     1    n,l,f,m,e,mup,de,mmax,r,vi
     1,   vps,d,dp,dpp,dc,dcp,dcpp,uu,tkli,svm,svm_roks)
c
...
ccccccccccccccccc chen: remove test on f(i) ccccccccccccccccccccc
...
!!!!!!!!!!! chen: always update wavefunction !!!!!!!!!!!!!!
